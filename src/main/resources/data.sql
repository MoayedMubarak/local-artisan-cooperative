...
OVERRIDING SYSTEM VALUE VALUES
  ...
  (10, 'Walnut Cheese Board Set',     'Solid walnut board with engraved floral border, paired with two hand-forged cheese knives.',                            145.00, 'woodwork',  'https://images.unsplash.com/photo-1621841957884-1210fe19d66d?w=600', 6,  'Marco Pottery', false, '2025-03-05', 3, 4),
  (11, 'Speckled Stoneware Vase',     'Tall 30 cm vase in warm speckled glaze. Perfect for dried or fresh florals.',                                           62.00,  'ceramics',  'https://images.unsplash.com/photo-1612196808214-b7e239e5f6b7?w=600', 9,  'Marco Pottery', false, '2025-03-10', 3, 1),
